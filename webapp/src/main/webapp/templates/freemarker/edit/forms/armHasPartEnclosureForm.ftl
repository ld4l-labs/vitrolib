    ...
    <br/>
      	...
      	<div id="partOfLookup">
	          ...
	          <p templateId="inputAcSelector">
	    		<label for="partOf">Related resource (lookup only)</label>
	              <input type="hidden"  name="partOfUri" id="partOfUri"/>
	              <input class="acSelector" size="60"  type="text" id="partOfName" name="partOfName" acGroupName="partOf"  value="" acUrl="${urls.base}/autocomplete?tokenize=true"/>
	          </p>
	
	
	          <div class="acSelection" acGroupName="partOf" >
	              <p class="inline">
	                  <label>${i18n().selected} resource:</label>
	                  <span class="acSelectionInfo"></span>
	                  <a href="" class="verifyMatch"  title="${i18n().verify_match_capitalized}">(${i18n().verify_match_capitalized}</a> ${i18n().or}
	                  <a href="#" class="changeSelection" id="changeSelection">${i18n().change_selection})</a>
	              </p>
	              <input class="acUriReceiver" type="hidden" id="partOf" name="partOf" value=""  />
...
<#include "existingValuesScript.ftl" />
  ...
  //regular autocomplete url: acUrl: '${urls.base}/autocomplete?tokenize=true',
    var customFormData  = {
        ...
        acTypes: {partOf: 'http://id.loc.gov/ontologies/bibframe/Instance,http://id.loc.gov/ontologies/bibframe/Item'},
